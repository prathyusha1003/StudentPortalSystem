...
<body>
	...
	<div class="card">
	 	<h1><b>Faculty Profile</b></h1>
		<div class="details">
		    <h3 id="dark01">Full Name<span id="art01">: ${faculty.name}</span></h3>
	    	<h3 id="dark02">Email Id<span id="art02">: ${faculty.email}</span></h3>
    	...
    	<br><br>
    	<div id="but">
			<a href="/faculty/edit-profile"><button id="button02"><b>Edit</b></button></a>
		</div>
	</div>
	<br><br>
